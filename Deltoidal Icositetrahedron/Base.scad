obj_height=.875; // Toggleable
slab_height=0.25; 
obj_width = 17; //adjust to make pretty
scale_factor = 1.0 / obj_width;
rotation = 90; //adjust to make pretty
filename="All.stl";
