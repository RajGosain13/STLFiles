obj_height=.85; // Toggleable
slab_height=0.25; 
obj_width = 32; //adjust to make pretty
scale_factor = 1.0 / obj_width;
rotation = 71; //adjust to make pretty
filename="All.stl";
