obj_height=.92; // Toggleable
slab_height=0.25; 
obj_width = 190; //adjust to make pretty
scale_factor = 1.0 / obj_width;
rotation = 120; //adjust to make pretty
filename="All.stl";
