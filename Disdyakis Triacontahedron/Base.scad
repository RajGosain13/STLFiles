obj_height=.925; // Toggleable
slab_height=0.25; 
obj_width = 45; //adjust to make pretty
scale_factor = 1.0 / obj_width;
rotation = 89; //adjust to make pretty
filename="All.stl";
